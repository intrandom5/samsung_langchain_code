...
from .tools import wikipedia_search, calculator, save_user_info, load_user_info, search_documents
...
agent = create_agent(
    model,
    tools=[calculator, wikipedia_search, save_user_info, load_user_info, search_documents],
